#AUS map coloring using singleton without heuristic
import copy
import random
...
def select_color(next_var):
    global australia_negh,australia_colors,assigned,stored,notconfirmed,final_color_to_js,final_list_to_js,aus_name,aus_naming
...
def  solve():
    global australia_colors,australia_negh,notconfirmed,final_color_to_js,final_list_to_js,aus_name
